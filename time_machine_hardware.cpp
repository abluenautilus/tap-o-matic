...
namespace time_machine
{
    ...
    const dsy_gpio_pin TimeMachineHardware::C5  = kPinMap[2][4];
    const dsy_gpio_pin TimeMachineHardware::C6  = kPinMap[2][5];
    const dsy_gpio_pin TimeMachineHardware::C7  = kPinMap[2][6];
    const dsy_gpio_pin TimeMachineHardware::C8  = kPinMap[2][7];
    const dsy_gpio_pin TimeMachineHardware::C9  = kPinMap[2][8];
    const dsy_gpio_pin TimeMachineHardware::C10 = kPinMap[2][9];
    const dsy_gpio_pin TimeMachineHardware::D1  = kPinMap[3][0];
    const dsy_gpio_pin TimeMachineHardware::D2  = kPinMap[3][1];
    const dsy_gpio_pin TimeMachineHardware::D3  = kPinMap[3][2];
    const dsy_gpio_pin TimeMachineHardware::D4  = kPinMap[3][3];
    const dsy_gpio_pin TimeMachineHardware::D5  = kPinMap[3][4];
    const dsy_gpio_pin TimeMachineHardware::D6  = kPinMap[3][5];
    const dsy_gpio_pin TimeMachineHardware::D7  = kPinMap[3][6];
    const dsy_gpio_pin TimeMachineHardware::D8  = kPinMap[3][7];
    const dsy_gpio_pin TimeMachineHardware::D9  = kPinMap[3][8];
    const dsy_gpio_pin TimeMachineHardware::D10 = kPinMap[3][9];
